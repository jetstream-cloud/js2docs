...
# Running Terraform
Make sure that you have setup and downloaded your openrc file. [Setting up the openrc.sh for the Jetstream2 CLI](../ui/cli/auth.md#setting-up-application-credentials-and-openrcsh-for-the-jetstream2-cli)
